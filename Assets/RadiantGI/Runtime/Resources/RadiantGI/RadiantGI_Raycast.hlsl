...
#define RGI_RAYCAST
	...
	#else
		#define _DownscaledDepthRT _CameraDepthTexture
		#define GetDepth(uv) GetLinearEyeDepth(uv)
		#define _DownscaledDepthRT_TexelSize _MainTex_TexelSize
	#endif
