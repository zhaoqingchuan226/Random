...
namespace RadiantGI.Universal {
    ...
    public class RadiantRenderFeature : ScriptableRendererFeature {
        ...
        static class ShaderParams {
            ...
            public const string SKW_USES_DOWNSCALED_DEPTH = "_USE_DOWNSCALED_DEPTH";
        ...
        class RadiantPass : ScriptableRenderPass {
            ...
            void RenderGI(CommandBuffer cmd, Camera cam) {
                ...
                if (downsampling > 1 || downsamplingDepth > 1) {
                    ...
                    mat.EnableKeyword(ShaderParams.SKW_USES_DOWNSCALED_DEPTH);
                } else {
                    mat.DisableKeyword(ShaderParams.SKW_USES_DOWNSCALED_DEPTH);
                }
            ...
            void SetupEmitters(List<RadiantVirtualEmitter> emitters) {
                ...
                for (int k = 0; k < kmax; k++) {
                    ...
                    emittersBoxMax[emittersCount] = emitterPosition + emitter.boxSize * 0.5f + emitter.boxCenter;
                    emittersBoxMin[emittersCount] = emitterPosition - emitter.boxSize * 0.5f + emitter.boxCenter;
                    emittersColors[emittersCount] = emitter.GetGIColor();
                    emittersCount++;
                }
            ...
            int EmittersDistanceComparer(RadiantVirtualEmitter p1, RadiantVirtualEmitter p2) {
                ...
                Bounds p1bounds = new Bounds(p1Pos + p1.boxCenter, p1.boxSize);
                Bounds p2bounds = new Bounds(p2Pos + p2.boxCenter, p2.boxSize);
