...
namespace OutlinesPack
{
    public class DepthMaskPass : ScriptableRenderPass
    {
        ...
        public DepthMaskPass(RenderPassEvent renderPassEvent, LayerMask outlinesLayerMask, string name, string shaderPath = "OutlinesPack/MaskShader", float downScale = 1)
        {
            ...
            maskMaterial = new Material(Shader.Find(shaderPath));
