...
public class OnlyOutlineEditor : ShaderGUI
{
    ...
    public  void FindProperties(MaterialProperty[] props) 
    {
        ...
        intensity = FindProperty("_Intesity", props);
        ...
        adaptive = FindProperty("_AdaptiveThicnkess", props);
        thicnkess = FindProperty("_Thicnkess", props);
