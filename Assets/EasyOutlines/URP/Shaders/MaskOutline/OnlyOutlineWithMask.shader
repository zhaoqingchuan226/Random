...
Shader "EasyOutlines/OnlyOutlineWithMask"
{
	Properties
	{
		...
		[ASEEnd]_MaskRef("Stencil Reference", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 staticSwitch14 = v.ase_normal;
				#elif defined(_OUTLINETYPE_POSITION)
				float3 staticSwitch14 = v.vertex.xyz;
				#elif defined(_OUTLINETYPE_UVBAKED)
				float3 staticSwitch14 = float3( v.ase_texcoord3.xy ,  0.0 );
				#else
				float3 staticSwitch14 = v.ase_normal;
				#endif
				...
				#endif
				float3 vertexValue = ( _Enabled == 1.0 ? ( lerpResult7 * ( staticSwitch14 * _Thicnkess ) ) : float3( 0,0,0 ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord26 = IN.ase_texcoord3.xy * float2( 1,1 ) + temp_output_25_0;
				...
				float3 Color = staticSwitch33.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
624;161;1693;631;1469.592;1148.215;1.628069;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-446.6332,60.1434;Inherit;False;Property;_Enabled;Enabled;12;1;[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;50;-254.3331,63.85244;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-533.8046,-265.8548;Inherit;False;Property;_Intesity;Intesity;6;0;Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;49;-1739.308,-462.3276;Inherit;False;DegreesToDirection;-1;;1;ef517114e559b014bb611423825a9296;0;1;6;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-191.3724,290.0021;Inherit;False;Property;_MaskRef;Stencil Reference;13;1;[Header];Create;False;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
...
WireConnection;45;5;50;0
ASEEND*/
//CHKSM=C20A8A9167DD9E4048F841F0119FF98B02987864